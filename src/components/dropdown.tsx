...
export const dropdown = tv({
  slots: {
    ...
    header: "px-3 py-2",
    content:
      "dropdown absolute z-10 w-64 -translate-y-1 scale-95 rounded-lg bg-card p-2 opacity-0 shadow ring-1 ring-border",
  ...
  variants: {
    position: {
      "top-left": { content: "left-0 mt-1 origin-top-left" },
      "top-right": { content: "right-0 mt-1 origin-top-right" },
